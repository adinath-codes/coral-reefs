...
export default function ConditionNode({ selected }: NodeProps) {
  return (
    <div
    ...
    >
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          <h3 className="text-white font-bold text-sm">If Condition</h3>
          <p className="text-gray-400 text-xs mt-1 leading-relaxed">
            Branch logic based on context state or LLM output.
          </p>
        </div>
      </div>
      <Handle
