...
export type ColumnsNodeType = Node<ColumnsData, "columns">;

export default function ColumnsNode({ selected }: NodeProps<ColumnsNodeType>) {
  return (
    <div
    ...
    >
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          <h3 className="text-white font-bold text-sm">Column Schema</h3>
